            ...
            var table = $('#datatable-daftar-po').DataTable({
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        targets: 7,
                        render: function(data, type, full, meta) {
                            var deleteData = '<a type="button" onclick="warning_delete(\'' + data.no_order + '\')" class="btn btn-icon waves-effect waves-light btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="Delete Data"><i class="fa fa-trash" ></i> </a>';
                            var review = '<a type="button" href="<?= base_url('manajemen_penjualan/reviewpurchaseorder/review/'); ?>' + data.no_order + '" class="btn btn-icon waves-effect waves-light btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Review"><i class="fa fa-edit" ></i> </a>';
                            var timeline = '<a type="button" href="<?= base_url('manajemen_penjualan/reviewpurchaseorder/timeline/'); ?>' + data.no_order + '" class="btn btn-icon waves-effect waves-light btn-inverse btn-sm" data-toggle="tooltip" data-placement="left" title="Timeline"><i class="fa fa-clock-o"></i> </a>';
                            if (data.status_po == "3" || data.status_po == "0") {
                                return deleteData + ' ' + review;
                            } else {
                                return timeline
                            }
                        }
