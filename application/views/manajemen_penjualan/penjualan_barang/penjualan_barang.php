    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <hr>
                <div class="form-group row">
                    <label class="col-5 col-form-label m-t-5">Discount (<span id="diskon_text">0</span>%)</label>
                    <div class="col-7">
...
<div id="modal_detail_penjualan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog md-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="data_label_chekcout">Detail</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input readonly id="dummy_harga_jual" autocomplete="off" name="harga_jual" type="text" class="form-control" placeholder="">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="button-penjualan-add" data-dismiss="modal" class="btn btn-primary waves-effect waves-light">Tambah</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
