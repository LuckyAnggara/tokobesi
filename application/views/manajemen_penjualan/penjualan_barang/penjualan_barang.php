                ...
                <div class="col-sm-8">
                    <div class="card-box">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="select_nama_barang" id="select_nama_barang" class="form-control" required>
                                </select>
                                <!-- <input placeholder="Kolom Pencarian Barang.." id="cari_barang" name="cari_barang" type="text" class="form-control"> -->
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-right m-t-30">
                                    <button type="submit" class="btn  btn-lg btn-secondary waves-effect waves-light"><i class="dripicons-cart"></i> Checkout</button>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
