            ...
            <form data-parsley-validate novalidate autocomplete="off" id="submitForm" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="modal-body">
                    <!-- <div id="rootwizard" class="pull-in">
                        <ul class="nav nav-pills nav-tabs nav-justified" id="tabtab" aria-orientation="vertical">
                            <li class="nav-item">
                    ...
                    <div id="rootwizard" class="pull-in">
                        <ul class="nav nav-pills nav-tabs nav-justified">
                            <li class="nav-item"><a href="#first" data-toggle="tab" class="nav-link">First</a></li>
                            <li class="nav-item"><a href="#second" data-toggle="tab" class="nav-link">Second</a></li>
                            <li class="nav-item"><a href="#third" data-toggle="tab" class="nav-link">Third</a></li>
                            <li class="nav-item"><a href="#forth" data-toggle="tab" class="nav-link">Forth</a></li>
                        </ul>
                        ...
                        <ul class="list-inline wizard mb-0 mt-4 pager">
