                                     ...
                                     <div class="clearfix">
                                         <div class="widget-user row">
                                             ...
                                             <div class="col-3 text-right">
                                                 <h4><b>Faktur Retur Pembelian</b></h4>
                                                 <p><?= $tanggal; ?></p>
                                             </div>
                                         </div>
                                         ...
                                         <div class="col-6">
                                             <div class="clearfix row m-t-10">
                                                 ...
                                                 <ul class="col-8" style="list-style-type:none">
                                                     <li class="text-left m-b-3"><?= $data_order['nama_supplier']; ?></li>
                                         ...
                                         <div class="col-4">
                                             <div class="clearfix row m-t-10">
                                                 ...
                                                 <ul class="col-7" style="list-style-type:none">
                                                     <li class="text-left m-b-3">#<?= $data_order['nomor_transaksi']; ?></li>
                                                 </ul>
                                             </div>
                                             <!-- end row -->
                                         </div>
                                     ...
                                     <div class="row">
                                         <div class="col-6">
                                             <div class="clearfix m-t-10">
                                                 ...
                                                 <p>
                                                     <?= nl2br($setting_perusahaan['catatan_retur_beli']); ?>
                                                 </p>
                                             </div>
                                         </div>
                                         <div class="col-6">
