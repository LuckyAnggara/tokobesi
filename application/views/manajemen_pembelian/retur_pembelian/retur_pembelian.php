        ...
        <div class="col-12">
            <div class="card-box">
                <div class="form-group row">
                    <h4 class="m-t-0 header-title">Data Transaksi</h4>
                </div>
                <hr>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-lg" id="nomor_transaksi">
    ...
    <div class="row" id="data_div" hidden>
        <div class="col-6">
            <div class="card-box">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input id="kode_supplier" name="kode_supplier" type="text" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="col-6">
            <div class="card-box">
                ...
                <div class="form-group row">
                    <label class="col-sm-4 col-sm-form-label m-t-10">Total Pembelian</label>
                    <div class="col-sm-8">
                        <input id="total_pembelian" name="total_pembelian" type="text" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row">
