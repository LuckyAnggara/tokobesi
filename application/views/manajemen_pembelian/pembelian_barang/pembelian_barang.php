                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="tanggal_transaksi">
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <h6 hidden id="no_order_pembelian">22</h6>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-right m-t-30">
                                    <button id="checkout" name="checkout" type="button" class="btn  btn-lg btn-primary waves-effect waves-light"><i class="fa fa-check"></i> Apply</button>
