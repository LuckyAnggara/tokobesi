                ...
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-master-jenis_barang" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            </table>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group">
                                ...
                                <input style="text-transform:uppercase" name="kode_jenis_barang" id="kode_jenis_barang" type="text" class="form-control" required aria-describedby="basic-addon1">
                            </div>
                            <small id="inputhelp" class="form-text text-muted">Kode Jenis Barang bersifat Unik, tidak bisa sama dengan data lainnya</small>
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="modal-body">
                <form data-parsley-validate novalidate autocomplete="off" id="edit_form" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Kode Jenis Barang</label>
                        <div class="col-9">
                            <input name="edit_kode_jenis_barang" id="edit_kode_jenis_barang" type="text" class="form-control" placeholder="" required>
                            <input name="edit_id_jenis_barang" id="edit_id_jenis_barang" type="text" class="form-control" placeholder="" hidden>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Nama Jenis Barang</label>
                        <div class="col-9">
                            <input name="edit_nama_jenis_barang" id="edit_nama_jenis_barang" type="text" class="form-control" placeholder="" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Keterangan</label>
