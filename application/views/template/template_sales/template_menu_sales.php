                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        <li class="has-submenu">
                            <a href="<?= base_url('dashboard/sales'); ?>"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard </span> </a>
                        </li>
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li>
                                    <ul>
                                        <li><a href="<?= base_url('manajemen_penjualan/purchaseordersales'); ?>">Order</a></li>
                                        <li><a href="<?= base_url('manajemen_penjualan/purchaseordersales/daftar'); ?>">Daftar</a></li>
