...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h5 class="page-title">Laporan Laba / Rugi Berjalan</h5>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 d-print-none">
            <div class="card-box">
                <div class="row">
                    <div class="col-12">
                        <form data-parsley-validate novalidate autocomplete="off" id="persediaan_form" enctype="multipart/form-data" class="form-horizontal" action="<?= base_url('laporan/laba/download'); ?>" method="post">
                ...
                <div class="card-box">
                    <div class="panel-body">
                        <div class="col-12" id="div_laba">
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="m-t-0 header-title">Laporan Laba / Rugi per Tanggal <span id="display_tanggal"><?= $tanggal_hari_ini; ?></span></h4>
                                </div>
                            </div>
                            <hr>
                            <ul style="list-style-type:none">
                                <div>
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-4 text-right m-t-10">
                                            <b><span class="text-danger" id="total_potongan_penjualan">( <?= rupiah($pendapatan['total_potongan_penjualan']); ?> )</span></b>
                                        </div>
                                    </li>
                                    <hr>
                                    <li class="row">
                                        ...
                                        <div class="col-6 text-right  m-t-5">
                                            <b id="total_penjualan_bersih"><?= rupiah($pendapatan['total_penjualan_bersih']); ?></b>
                                        </div>
                                    </li>
                                </div>
                                <hr>
                                <div>
                                    <li class="row">
                                        ...
                                        <div class="col-4 text-right">
                                            <span id="persediaan_awal"><?= rupiah($pendapatan['persediaan_awal']); ?></span>
                                        </div>
                                    </li>
                                    <li class="row">
                                        <div class="col-4">
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-6 text-right m-t-10">
                                            <b><span id="persediaan_tersedia"><?= rupiah($pendapatan['persediaan_tersedia']); ?></span></b>
                                        </div>
                                    </li>
                                    <li class="row">
                                        <div class="col-4 m-t-10">
                                        ...
                                        <div class="col-6 text-right m-t-10">
                                            <b><span class="text-danger" id="persediaan_akhir">(<?= rupiah($pendapatan['persediaan_akhir']); ?>)</span></b>
                                        </div>
                                    </li>
                                    <hr class="m-t-10">
                                    <li class="row">
                                        ...
                                        <div class="col-6 text-right">
                                            <b><span id="harga_pokok_penjualan" class="text-danger">(<?= rupiah($pendapatan['harga_pokok_penjualan']); ?>)</span></b>
                                        </div>
                                    </li>
                                </div>
                                <li>
                                        ...
                                        <div class="col-6 text-right">
                                            <b id="laba_penjualan">
                                                <?php if ($pendapatan['laba_penjualan'] < 0) {; ?>
                                                    <span class="text-danger">( <?= rupiah($pendapatan['laba_penjualan']); ?> )</span>
                                                <?php } else {; ?>
                                ...
                                <div>
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-6 text-right  m-t-5">
                                            <b id="total_pendapatan_lain"><?= rupiah($pendapatan['total_pendapatan_lain']); ?></b>
                                        </div>
                                    </li>
                                </div>
                                <hr class="m-t-10">
                                            ...
                                            <div class="col-6 text-right">
                                                <b id="total_pendapatan_bersih">
                                                    <?php if ($total_pendapatan_bersih < 0) {; ?>
                                                        <span class="text-danger">( <?= rupiah($total_pendapatan_bersih); ?> )</span>
                                                    <?php } else {; ?>
