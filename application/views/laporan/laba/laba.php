                                ...
                                <h5>
                                    ...
                                    <div>
                                        <li class="row">
                                            ...
                                            <div class="col-6 text-right m-b-10">
                                                <b id="total_penjualan"><?= rupiah($persediaan_awal); ?></b>
                                            </div>
                                        </li>
                                        <li class="row">
                                            <div class="col-6">
                                        ...
                                        <li class="row">
                                            ...
                                            <div class="col-6 text-right m-t-10">
                                                <b><span id="total_potongan_penjualan"><?= rupiah($persediaan_barang_dijual); ?></span></b>
                                            </div>
                                        </li>
                                        <li class="row">
                                            <div class="col-6 m-t-10">
                                            ...
                                            <div class="col-6 text-right m-t-10">
                                                <b><span class="text-danger" id="total_potongan_penjualan">(<?= rupiah($persediaan_akhir); ?>)</span></b>
                                            </div>
                                        </li>
                                        <hr class="m-t-10">
                                        <li class="row">
                                            ...
                                            <div class="col-6 text-right">
                                                <b><span id="harga_pokok_penjualan"><?= rupiah($harga_pokok_penjualan); ?></span></b>
                                            </div>
                                        </li>
                                    </div>
                                    <li>
            ...
            <div class="card-box">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <button disabled name="proses" id="proses" class="btn btn-primary waves-effect waves-light">
                                    <span>Generate</span>
                                </button>
                            </div>
                        </div>
