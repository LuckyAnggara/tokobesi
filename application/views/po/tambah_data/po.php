                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="inputAddress2" class="col-form-label">Catatan</label>
                            <textarea type="text" rows="40" class="form-control" id="keterangan" placeholder="Catatan untuk tujuan"></textarea>
                        </div>
                    </div>
                </div>
            </div>
