            ...
            <div class="card-box">
                <form autocomplete="off" id="submitForm" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="65%"><a href="javascript:void(0);" class="edit_input" id="nama_perusahaan"></a></td>
                                        </tr>
                                        <tr>
                                            <td>Alamat Perusahaan</td>
                                            <td><a href="javascript:void(0);" id="alamat_perusahaan" class="edit_textarea"></a></td>
                                        </tr>
                                        <tr>
                                            <td width="35%">Nomor Telepon</td>
                                            <td width="65%"><a href="javascript:void(0);" class="edit_input" id="nomor_telepon"></a></td>
                                        </tr>
                                        <tr>
                                            <td width="35%">Nomor Fax</td>
                                            <td width="65%"><a href="javascript:void(0);" class="edit_input" id="nomor_fax"></a></td>
                                        </tr>
                                        <tr>
                                            <td width="35%">Alamat Email</td>
                                            <td width="65%"><a href="javascript:void(0);" class="edit_input" id="alamat_email"></a></td>
                                        </tr>
                                        <tr>
                                            <td width="35%">Logo Perusahaan</td>
                                            <td>
                                                <div id="div_gambar">
                                                    <img id="gambar_logo" src="" width="25%" height="25%" class="img-thumbnail" alt="Logo Perusahaan">
                                                    <div class="float-right">
                                                        <button type="button" id="edit_gambar_button" name="edit_gambar_button" class="btn btn-primary waves-effect waves-light"><i class="fa fa-image"></i> Ganti Gambar</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="65%"><a href="javascript:void(0);" class="edit_input" id="prefix_faktur"></a></td>
                                                </tr>
                                                <tr>
                                                    <td>Nomor</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript:void(0);" id="catatan_faktur_cash" class="edit_textarea"></a></td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="button-add" class="btn btn-success waves-effect waves-light">Apply Changes</button>
                    </div>
                </form>
            </div>
        </div>
