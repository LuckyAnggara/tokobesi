...
class Model_Gaji extends CI_Model
{
    ...
    public function get_master_gaji()
    {
        ...
        $this->db->order_by('master_gaji.id', 'DESC');
        return $this->db->get();
    }
    ...
    public function get_detail_master_gaji($no_ref, $jenis_pembayaran)
    {
    ...
    public function bayar_master($post)
    {
        $data = [
            'status' => 2,
    ...
    public function bayar_detail($post)
    {
    ...
    public function bonus_sales($nip)
    {
        $bulan = date('m');
        $tahun = date('Y');
    ...
    public function delete_master_gaji($no_ref)
    {
        $this->db->where('nomor_referensi', $no_ref);
    ...
    public function ubah_gaji_pokok($post)
    {
    ...
    public function ubah_uang_makan($post)
    {
    ...
    public function ubah_bonus($post)
    {
    ...
    public function ubah_total($post, $type)
    {
    ...
    public function get_view_master_gaji($no_ref)
    {
    ...
    public function get_view_detail_gaji($no_ref)
    {
        $this->db->select('master_pegawai.nama_lengkap,master_pegawai.jabatan, detail_gaji.id as idid, detail_gaji.*');
        $this->db->from('detail_gaji');
        $this->db->join('master_pegawai', 'master_pegawai.nip = detail_gaji.nip');
