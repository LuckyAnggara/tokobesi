...
{
    public function get_kategori_biaya($query)
    {
        $this->db->select('*');
    ...
    public function get_daftar_biaya_histori($post)
    {
    ...
    public function get_total_biaya($post)
    {
        $tanggal_awal = $post['tanggal_awal'];
        $tanggal_akhir = $post['tanggal_akhir'];
        $periode = $this->modelSetting->get_data_periode();
    ...
    public function tambah_biaya($post)
    {
    ...
    public function revisi_biaya($post)
    {
        $this->db->select('*');
        $this->db->from('detail_biaya');
