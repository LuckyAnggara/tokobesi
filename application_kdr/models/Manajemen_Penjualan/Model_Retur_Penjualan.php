...
class Model_Retur_Penjualan extends CI_Model
{
    ...
    public function tambah_data_master($post)
    {
    ...
    public function tambah_data_detail($post)
    {
    ...
    public function get_data_retur($post)
    {
        $periode = $this->modelSetting->get_data_periode();
    ...
    public function delete_data($nomor_faktur)
    {
    ...
    public function get_data_faktur($nomor_faktur) // udah include nominal pembayaran dan status
    ...
    public function get_detail_faktur($nomor_faktur)
    {
        $this->db->select('*');
