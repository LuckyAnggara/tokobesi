...
$tanggal_jtempo = $data_utang['tanggal_jatuh_tempo'];
$tanggal_jtempo = tgl_indo(date("Y-m-d-D", strtotime($tanggal_jtempo)));

// if ($data_order['status_pelanggan'] == 1) {
//     $kode_supplier = "Walk in Costumer";
// } else {
//     $kode_supplier = $data_order['kode_supplier'];
// }
...
?>
<label hidden id="saldo_utang_text">Status Pembayaran</label>
<div class="container-fluid">
    <!-- Page-Title -->
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">Detail Piutang</h4> <span hidden id="nomor_transaksi"><?= $data_order['nomor_transaksi']; ?></span>
        </div>
    </div>
    <div class="row">
        <div class="col-6">
            <div class="card-box">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input id="kode_supplier" name="kode_supplier" type="text" class="form-control" value="<?= $data_order['kode_supplier']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
