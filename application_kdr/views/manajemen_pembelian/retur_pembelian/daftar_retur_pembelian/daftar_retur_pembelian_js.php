...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function init_table(tanggal_awal = "01-01-" + new Date().getFullYear(), tanggal_akhir = "31-12-" + new Date().getFullYear()) {
            ...
            var table = $('#datatable-daftar-retur-pembelian').DataTable({
                destroy: true,
                paging: true,
                "oLanguage": {
                ...
                "ordering": false,
                "ajax": {
                    "url": '<?= base_url("manajemen_pembelian/returpembelian/getDataRetur/"); ?>',
                    "data": input,
                    "type": "POST",
                },
                "columnDefs": [{
...
<script>
    function view_faktur(nomor_transaksi) {
        window.location.href = "<?= base_url('manajemen_pembelian/returpembelian/faktur/'); ?>" + nomor_transaksi;
    }
</script>
<!-- Script Delete Data -->
...
<script type="text/javascript">
    ...
    function deleteData(nomor_transaksi) {
        $.ajax({
            url: "<?= base_url('manajemen_pembelian/returpembelian/delete_faktur/'); ?>",
            type: "post",
            data: {
                nomor_transaksi: nomor_transaksi
            },
