<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card-box">
                <div class="form-group row">
                    <h4 class="m-t-0 header-title">Laporan Utang</h4>
                </div>
                <hr>
        ...
        <div class="col-6">
            <div class="card-box">
                <div class="form-group row">
                    <h4 class="m-t-0 header-title">Laporan Piutang</h4>
                </div>
                <hr>
                <form data-parsley-validate novalidate autocomplete="off" id="utang_form" enctype="multipart/form-data" class="form-horizontal" action="<?= base_url('laporan/utangpiutang/laporan_piutang/'); ?>" method="post">
                    <div class="form-group row">
                        <label class="col-3 col-sm-form-label">Penyajian Data</label>
                        <div class="col-9">
                            <select name="data" class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group">
                                <input type="text" autocomplete="off" class="form-control" placeholder="mm/dd/yyyy" name="tanggal" id="tanggal_piutang" required>
                                <div class="input-group-append">
                                    <span class="input-group-text btn-inverse"><i class="ti-calendar"></i></span>
                                </div>
                            </div><!-- input-group -->
