						...
						<div class="col-9">
							<select class="form-control" id="periode">
								...
								<option value="<?=$value['id'];?>"
									<?php echo ($value['cek'] == 1) ? 'selected' : ''; ?>><?=$value['periode'];?>
								</option>
								<?php endforeach;?>
							</select>
						</div>
				...
				<div class="row">
					<div class="col-12">
						<form data-parsley-validate novalidate autocomplete="off" id="persediaan_form"
							...
							action="<?=base_url('laporan/labapenjualan/download');?>" method="post">
							<div class="form-group row">
								<label class="col-3 col-sm-form-label m-t-10">Tanggal</label>
                                <input type="text" id="kode_periode" hidden name="periode">
								<div class="col-9">
				...
				<div class="card-box">
					...
					<div class="panel-body">
						<div class="col-12" id="div_laba">
							<div class="row">
								<div class="col-12">
									<h4 class="m-t-0 header-title">Laporan Laba / Rugi Penjualan per Tanggal <span
								...
								<h5>
									<div>
										<li class="row">
											...
											<div class="col-6 text-right m-b-10">
												<b
													id="total_penjualan"><?=rupiah($laba_penjualan['total_penjualan']);?></b>
											</div>
										</li>
										<li class="row">
											<div class="col-6">
										...
										<li class="row">
											...
											<div class="col-6 text-right m-t-10">
												<b><span class="text-danger" id="total_potongan_penjualan">(
														<?=rupiah($laba_penjualan['total_potongan_penjualan']);?>
														)</span></b>
											</div>
										</li>
										<hr>
										<li class="row">
											...
											<div class="col-6 text-right  m-t-5">
												<b
													id="total_penjualan_bersih"><?=rupiah($laba_penjualan['total_penjualan'] - $laba_penjualan['total_potongan_penjualan']);?></b>
											</div>
										</li>
									</div>
									<hr>
									<div>
										<li class="row">
											...
											<div class="col-6 text-right m-b-10">
												<b
													id="persediaan_awal"><?=rupiah($laba_penjualan['persediaan_awal']);?></b>
											</div>
										</li>
										<li class="row">
											<div class="col-6">
										...
										<li class="row">
											...
											<div class="col-6 text-right m-t-10">
												<b><span
														id="persediaan_tersedia"><?=rupiah($laba_penjualan['persediaan_tersedia']);?></span></b>
											</div>
										</li>
										<li class="row">
											<div class="col-6 m-t-10">
											...
											<div class="col-6 text-right m-t-10">
												<b><span class="text-danger"
														id="persediaan_akhir">(<?=rupiah($laba_penjualan['persediaan_akhir']);?>)</span></b>
											</div>
										</li>
										<hr class="m-t-10">
										<li class="row">
											...
											<div class="col-6 text-right">
												<b><span
														id="harga_pokok_penjualan"><?=rupiah($laba_penjualan['harga_pokok_penjualan']);?></span></b>
											</div>
										</li>
									</div>
									<li>
										...
										<div class="col-6 text-right">
											<b id="laba_penjualan">
												...
												<span class="text-danger">(
													<?=rupiah($laba_penjualan['laba_penjualan']);?> )</span>
												<?php } else {;?>
