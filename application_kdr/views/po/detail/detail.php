             <?php
                ...
                $tanggal_po = $data_po['tanggal_transaksi'];
                     ...
                     <div class="col-sm-12">
                         <div class="btn-group pull-right page-title">
                             <?php if ($data_po['status']  == 0) { ?>
                                 <a type="button" id="print_btn" class="m-t-20 btn btn-warning waves-effect waves-light"> Belum Terkirim </a>
                             <?php } else if ($data_po['status']  == 1) { ?>
                             ...
                             <div class="card-box">
                                 <div class="panel-body">
                                         ...
                                         <div class="col-md-12">
                                             <div class="table-responsive">
                                                 <table class="table table-bordered">
                                                     ...
                                                     <tbody">
                                                         <?php foreach ($data_po['detail_po'] as $key => $value) : ?>
                                                             <tr>
                                                                 <td><?php
                                                                        echo $no++; ?></td>
                                     ...
                                     <div class="row text-center">
                                         <div class="col-6">
                                             <p>Hormat Kami</p>
                                             <p><?= $setting_perusahaan['nama_perusahaan']; ?></p>
                                         </div>
                                     </div>
                                     <hr>
