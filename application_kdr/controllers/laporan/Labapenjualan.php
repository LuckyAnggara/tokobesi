...
class Labapenjualan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['laba_penjualan'] = $this->modelLabaPenjualan->get_data_laba_penjualan($hari, $bulan, $tahun, $periode);
    ...
    public function generate_data()
    {
        ...
        $data = $this->modelLabaPenjualan->get_data_laba_penjualan($hari, $bulan, $tahun, $periode);
    ...
    public function cek()
    {
        ...
        $output = $this->modelLabaPenjualan->get_data_laba_penjualan($hari, $bulan, $tahun, $periode);
        $output = json_encode($output);
        echo $output;
    }
