...
class Penjualanbarang extends CI_Controller
{
    ...
    public function cek_duplikat($no_order)
    {
    ...
    public function get_diskon($kode_diskon)
    {
    ...
    public function bayar_checkout()
    {
        $post = $this->input->post();
        $data = $this->modelPenjualan->proses_penjualan($post);
    }

    public function invoice($no_order_penjualan)
    {
        $data['setting_perusahaan'] = $this->modelSetting->get_data_perusahaan();
        $data['menu'] = $this->modelSetting->data_menu();
    ...
    public function cekPasswordOverride()
    {
        $this->db->select('*');
    ...
    public function get_data_persediaan($kode_barang)
    {
        $output = $this->modelPersediaan->get_data_persediaan($kode_barang);
        echo $output;
    }

    public function cek_pelanggan($id_pelanggan = "")
    {
